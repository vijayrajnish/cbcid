...
!function($) {
  ...
  function Collapse (el, options) {
    ...
    _this.$el.find(query).each(function() {
      ...
      _this.states[section._index()] || section.$summary.hasClass("open1") ?
  ...
  Section.prototype = {
    ...
    open: function(bypass) {
      ...
      _this._changeState("open1", bypass)
    },
    _index: function() {
    ...
    _changeState: function(state, bypass) {
      ...
      var _this = this;
      _this.isOpen = state == "open1"
      if($.isFunction(_this.options[state]) && !bypass) {
        _this.options[state].apply(_this.$details)
      } else {
        _this.isOpen ? _this.$details.show() : _this.$details.hide();
      }
      _this.$summary.removeClass("open1 close").addClass(state);
