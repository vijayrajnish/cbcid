...
/***/ (function(module, exports) {
	...
	var selectDropdowns = function selectDropdowns() {
	  ...
	  $('.country-icons ul li').each(function () {
	    ...
	    if ($.trim(countryOptions) === 'English') {
	      $(this).prepend('<img src="../Content/assets/img/icons/flags/US.png" class="max-w-20 m-r-10" alt="" />');
	    } else if ($.trim(countryOptions) === 'Español') {
			$(this).prepend('<img src="../Content/assets/img/icons/flags/ES.png" class="max-w-20 m-r-10" alt="" />');
	    } else if ($.trim(countryOptions) === 'Français') {
			$(this).prepend('<img src="../Content/assets/img/icons/flags/FR.png" class="max-w-20 m-r-10" alt="" />');
	    } else if ($.trim(countryOptions) === 'Italiano') {
			$(this).prepend('<img src="../Content/assets/img/icons/flags/IT.png" class="max-w-20 m-r-10" alt="" />');
	    }
	  });
	...
	var pikaday = function pikaday() {
	 ...
	 var pickerTheme = new Pikaday({
		field: document.getElementById('datepicker-theme'), theme: 'dark-theme',
		format: 'DD/MM/YYYY' });
	  var startDate,
	      endDate,
