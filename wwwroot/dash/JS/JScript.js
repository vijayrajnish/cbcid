    function convert_to_Unicode_and_Chanakya(id,id2) {

//        debugger;
        convert_Kritidev10_to_Unicode(id);

        function convert_Kritidev10_to_Unicode(id) {
...
"ो", "ॉ", "ैं", "्रे", "औ", "ओ", "ऑ")
            ...
            //            var modified_substring = document.getElementById("txtDep_name").value;
            var modified_substring = document.getElementById(id).value;

            //****************************************************************************************
            //  Break the long text into small bunches of max. max_text_size  characters each.
            //****************************************************************************************
            //            var text_size = document.getElementById("txtDep_name").value.length;
            ...
            while (chale_chalo == 1) {
                ...
                document.getElementById(id2).value = processed_Unicode_text;

                //document.getElementById(id1).innerText = processed_Unicode_text;
            }
